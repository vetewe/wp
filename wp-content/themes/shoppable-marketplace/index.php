...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<!--Blog Display-->
			<?php get_template_part( 'template-parts/display/display' ); ?>
			
			<!--Blog Followers-->
			<?php get_template_part( 'template-parts/followers/followers' ); ?>

			<!--Blog Survey-->
			<?php get_template_part( 'template-parts/survey/survey' ); ?>

			<!--Blog Companions-->
			<?php get_template_part( 'template-parts/companions/companions' ); ?>
							...
							<?php
								if( get_theme_mod( 'enable_pagination', true ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'shoppable-marketplace' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'shoppable-marketplace' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'shoppable-marketplace' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'shoppable-marketplace' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'shoppable-marketplace' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
