<?php
$page_one 	= get_theme_mod( 'survey_page_one', '' );
$page_two 	= get_theme_mod( 'survey_page_two', '' );
$page_three = get_theme_mod( 'survey_page_three', '' ); 
...
if( get_theme_mod( 'survey_section', false ) && $has_page ){ ?>
	<section class="section-survey-area">
