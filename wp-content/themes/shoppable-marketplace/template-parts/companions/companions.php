<?php
$page_one 	= get_theme_mod( 'companions_page_one', '' );
$page_two 	= get_theme_mod( 'companions_page_two', '' );
$page_three = get_theme_mod( 'companions_page_three', '' );
$page_four  = get_theme_mod( 'companions_page_four', '' ); 
...
if( get_theme_mod( 'companions_section', false ) && $has_page ){ ?>
	<section class="section-companion-area">
		<div class="content-wrap">
			<div class="row">
				<?php foreach( $page_array as $each_page ){ ?>
					<div class="col-md-6 col-lg-3">
						<article class="companion-content-wrap">
							...
							<div class="companion-content">
								...
								<div class="button-container">
									<a href="<?php echo esc_url( get_permalink( $each_page[ 'ID' ] ) ); ?>" class="button-text">
										<?php echo esc_html__( 'Continue reading', 'shoppable-marketplace' ); ?>
